...
-- Listage de la structure de la base pour pixerian_template
CREATE DATABASE IF NOT EXISTS `pixerian_template` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `pixerian_template`;
...
-- Listage des données de la table pixerian_template.addon_account : ~4 rows (environ)
...
-- Listage des données de la table pixerian_template.addon_account_data : ~5 rows (environ)
...
-- Listage des données de la table pixerian_template.addon_inventory : ~3 rows (environ)
...
-- Listage de la structure de table pixerian_template. cardealer_vehicles
...
-- Listage des données de la table pixerian_template.cardealer_vehicles : ~0 rows (environ)
...
-- Listage des données de la table pixerian_template.datastore : ~6 rows (environ)
...
-- Listage des données de la table pixerian_template.datastore_data : ~2 rows (environ)
...
-- Listage des données de la table pixerian_template.items : ~9 rows (environ)
...
-- Listage des données de la table pixerian_template.jobs : ~3 rows (environ)
...
-- Listage des données de la table pixerian_template.job_grades : ~0 rows (environ)
...
-- Listage de la structure de table pixerian_template. owned_properties
...
-- Listage des données de la table pixerian_template.owned_properties : ~0 rows (environ)

-- Listage de la structure de table pixerian_template. owned_vehicles
...
-- Listage des données de la table pixerian_template.owned_vehicles : ~0 rows (environ)

-- Listage de la structure de table pixerian_template. rented_vehicles
...
-- Listage des données de la table pixerian_template.rented_vehicles : ~0 rows (environ)
...
-- Listage de la structure de table pixerian_template. user_contacts
...
-- Listage des données de la table pixerian_template.user_contacts : ~0 rows (environ)
...
-- Listage de la structure de table pixerian_template. user_parkings
...
-- Listage des données de la table pixerian_template.user_parkings : ~0 rows (environ)

-- Listage de la structure de table pixerian_template. vehicles
...
-- Listage des données de la table pixerian_template.vehicles : ~0 rows (environ)
...
-- Listage de la structure de table pixerian_template. vehicle_categories
...
-- Listage des données de la table pixerian_template.vehicle_categories : ~0 rows (environ)
...
-- Listage de la structure de table pixerian_template. vehicle_sold
...
-- Listage des données de la table pixerian_template.vehicle_sold : ~0 rows (environ)
